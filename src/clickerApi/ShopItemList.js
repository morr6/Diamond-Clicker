export const shopItems = [ 
    ...
    { name: 'wooden pickaxe', amount: 0, cost: 500, increaseCostValue: 8,
        lvlNeeded: 5, diamondsPerSecond: 25, note:'"wooden pickaxe, is it possible?"'},
    { name: 'stone pickaxe', amount: 0, cost: 2500, increaseCostValue: 11, 
        lvlNeeded: 8, diamondsPerSecond: 50, note:'"finally usefull tool"'},  
    { name: 'iron pickaxe', amount: 0, cost: 5000, increaseCostValue: 13,
        lvlNeeded: 9, diamondsPerSecond: 100, note:'"better version of the previous one"'}, 
    { name: 'golden pickaxe', amount: 0, cost: 75000, increaseCostValue: 17,
        lvlNeeded: 10, diamondsPerSecond: 250, note:'"this one is weak"'},
    { name: 'diamond pickaxe', amount: 0, cost: 15000, increaseCostValue: 20,
