export const achievementList = [ 
    ...
    { id: 7, unlocked: false, shouldBeUnlcoked: (state) => state.items[0].amount === 10 ,
        name: 'Even more hands!', note: 'buy 10 hands'}, 
    ...
    { id: 10, unlocked: false, shouldBeUnlcoked: (state) => state.items[1].amount === 1 ,
        name: 'Making bonefire?', note: 'buy 10 sticks'}, 
    ...
    { id: 13, unlocked: false, shouldBeUnlcoked: (state) => state.items[2].amount === 10 ,
        name: 'actually these are weak!', note: 'buy 10 wooden pickaxes'}, 
    ...
    { id: 16, unlocked: false, shouldBeUnlcoked: (state) => state.items[3].amount === 10 ,
        name: 'go go digger!', note: 'buy 10 stone pickaxes'}, 
    { id: 17, unlocked: false, shouldBeUnlcoked: (state) => state.items[3].amount === 25 ,
        name: 'Stone stone stone!', note: 'buy 50 stone pickaxes'},
    { id: 18, unlocked: false, shouldBeUnlcoked: (state) => state.items[4].amount === 1 ,
        name: 'Finally iron!', note: 'buy 1 iron pickaxe'}, 
    { id: 19, unlocked: false, shouldBeUnlcoked: (state) => state.items[4].amount === 10 ,
        name: 'Iron looks nice!', note: 'buy 10 iron pickaxes'}, 
    { id: 20, unlocked: false, shouldBeUnlcoked: (state) => state.items[4].amount === 25 ,
        name: 'are they heavy?', note: 'buy 50 iron pickaxes'},
    { id: 21, unlocked: false, shouldBeUnlcoked: (state) => state.items[5].amount === 1 ,
        name: 'Why did you buy it?', note: 'buy 1 golden pickaxe'}, 
    { id: 22, unlocked: false, shouldBeUnlcoked: (state) => state.items[5].amount === 10 ,
        name: 'iron is better acutally!', note: 'buy 10 golden pickaxes'}, 
    { id: 23, unlocked: false, shouldBeUnlcoked: (state) => state.items[5].amount === 25 ,
        name: 'STOP IT!', note: 'buy 50 golden pickaxes'},
    { id: 24, unlocked: false, shouldBeUnlcoked: (state) => state.items[6].amount === 1 ,
        name: 'shiny *.*', note: 'buy 1 diamond pickaxes'}, 
    { id: 25, unlocked: false, shouldBeUnlcoked: (state) => state.items[6].amount === 10 ,
        name: 'these are good!', note: 'buy 10diamond pickaxes'}, 
    ...
    { id: 28, unlocked: false, shouldBeUnlcoked: (state) => state.items[7].amount === 10 ,
        name: 'can you deal with them?', note: 'buy 10 tnt'}, 
    { id: 29, unlocked: false, shouldBeUnlcoked: (state) => state.items[7].amount === 25 ,
        name: 'it\'s probably dangerous', note: 'buy 50 tnt'},
    { id: 30, unlocked: false, shouldBeUnlcoked: (state) => state.items[8].amount === 1 ,
        name: 'the best way to dig!', note: 'buy 1 creeper'}, 
    { id: 31, unlocked: false, shouldBeUnlcoked: (state) => state.items[8].amount === 10 ,
        name: 'SSSSssssss...', note: 'buy 10 creepers'}, 
